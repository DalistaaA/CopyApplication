...
//		Assertions.assertFalse(filesUtils.copyFolder(sourceDir9, targetDir9));
	...
	@Test
	void test_checkSourceExisting() {
		Validation validation = new Validation();
		File source = new File("C://A/bbb.txt");	
		Assertions.assertTrue(validation.checkSourceExisting(source));
		
		File source1 = new File("C://A/bbb.txt");
		//Assertions.assertFalse(validation.checkSourceExisting(source1));
